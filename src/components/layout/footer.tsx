  ...
  return (
    <footer className="w-full border-t border-gray-700 mt-16 text-gray-400">
      <div className="max-w-6xl mx-auto px-6 py-10 flex flex-col md:flex-row justify-between items-center space-y-6 md:space-y-0">
        <Image className="rounded h-20 w-20" src="/castlingFinancial.png" alt="Logo" width={80} height={80} />
        <FooterMenu />
        <div className="text-center md:text-left md:max-w-xs">
          <p className="text-sm">&copy; {new Date().getFullYear()} Castling Financial. All rights reserved.</p>
